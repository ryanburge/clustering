...
*The following section will create two things: a reltrad variable coded from 1-7 for each of the seven categories of reltrad and seven dummy variables for each of the seven categories*
evangelical <- xev
mainline <- xml
blackprot <- xbp
catholic <- xcath
...
*If using the GSS cumulative file from 1972-2014 there should be a total of 14,579 evangelicals in the sample*
*These are unweighted frequencies, generated by using the formula -- tab evangelical if year == 2012, for example*
*Evangelicals in 2014 = 585
*Evangelicals in 2012 = 503
*Evangelicals in 2010 = 484

*Evangelicals in 2008 = 481
*Evangelicals in 2006 = 1088
*Evangelicals in 2004 = 746
*Evangelicals in 2002 = 644
*Evangelicals in 2000 = 679
*Evangelicals in 1998 = 713
*Evangelicals in 1996 = 733
*Evangelicals in 1994 = 797
